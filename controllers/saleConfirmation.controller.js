...
export const generateForm = async (req, res) => {
  ...
  try {
    ...
    const new_form = {
      ...
      "quot_data" : `${parseInt(Data.dataValues.quotation_form.day)}- ${parseInt(Data.dataValues.quotation_form.month)}-${parseInt(Data.dataValues.quotation_form.year)}`,
      ...
      "items" : quot_item.map((item,key) => {
        ...
        if (item.straight_bush === null && item.plate_strip === null && item.doublebracket_bush === null && item.middlebracket_bush === null) {
          ...
          p_calc = ((parseFloat(item.bracket_bush.bigger_diameter)/2)*(parseFloat(item.bracket_bush.bigger_diameter)/2)*3.14*parseFloat(item.bracket_bush.bracket_length)*8.6-(parseFloat(item.bracket_bush.body_diameter)/2)*(parseFloat(item.bracket_bush.body_diameter)/2)*3.14*parseFloat(item.bracket_bush.bracket_length)*8,6)/1000000+((parseFloat(item.bracket_bush.body_diameter)/2)*(parseFloat(item.bracket_bush.body_diameter)/2)*3.14*parseFloat(item.bracket_bush.bush_length)*8.6-(parseFloat(item.bracket_bush.inner_diameter)/2)*(parseFloat(item.bracket_bush.inner_diameter)/2)*3.14*(item.bracket_bush.bush_length)*8.6)/1000000
          ...
          p_calc = parseFloat((parseFloat(item.straight_bush.large_diameter) * parseFloat(item.straight_bush.large_diameter) * 3.14 * parseFloat(item.straight_bush.bush_length) * 8.6 - (parseFloat(item.straight_bush.inner_diameter) / 2) * (parseFloat(item.straight_bush.inner_diameter) / 2) *3.14 * parseFloat(item.straight_bush.bush_length) * 8.6)/1000000)
        } if(item.bracket_bush === null && item.straight_bush === null && item.doublebracket_bush === null && item.middlebracket_bush === null) {
          p_calc = parseFloat(parseFloat(item.plate_strip.width) * parseFloat(item.plate_strip["length"]) * parseFloat(item.plate_strip.thickness) *8.6 / 1000000)
          ...
          p_calc = ((parseFloat(item.doublebracket_bush.bigger_diameter)/2)*(parseFloat(item.doublebracket_bush.bigger_diameter)/2)*3.14*8.6*parseFloat(item.doublebracket_bush.bracket_l1)-(parseFloat(item.doublebracket_bush.inner_diameter)/2)*(parseFloat(item.doublebracket_bush.inner_diameter)/2)*3.14*8.6*parseFloat(item.doublebracket_bush.bracket_l1))/1000000+((parseFloat(item.doublebracket_bush.body_diameter)/2)*(parseFloat(item.doublebracket_bush.body_diameter)/2)*3.14*8.6*parseFloat(item.doublebracket_bush.bracket_l3)-(parseFloat(item.doublebracket_bush.inner_diameter)/2)*(parseFloat(item.doublebracket_bush.inner_diameter)/2)*3.14*8.6*parseFloat(item.doublebracket_bush.bracket_l3))/1000000+((parseFloat(item.doublebracket_bush.bigger_diameter)/2)*(parseFloat(item.doublebracket_bush.bigger_diameter)/2)*3.14*8.6*parseFloat(item.doublebracket_bush.bracket_l2)-(parseFloat(item.doublebracket_bush.inner_diameter)/2)*(parseFloat(item.doublebracket_bush.inner_diameter)/2)*3.14*8.6*parseFloat(item.doublebracket_bush.bracket_l2))/1000000
          ...
          p_calc =((A8/2)*(A8/2)*3.14*8.6*E8-(B8/2)*(B8/2)*3.14*8.6*E8)/1000000+((A8/2)*(A8/2)*3.14*8.6*G8-(C8/2)*(C8/2)*3.14*8.6*G8)/1000000+((A8/2)*(A8/2)*3.14*8.6*F8-(D8/2)*(D8/2)*3.14*8.6*F8)/1000000
        }
